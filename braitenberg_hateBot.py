...
class Agent(object):
    ...
    def stepController(self):
        ...
        rotation =0
        rotation += (int(self.getObjectTypeAtSensor(0)/2)*-1) * SensorBelt[0] 
        rotation += (int(self.getObjectTypeAtSensor(1)/2)*-1) * SensorBelt[1] 
        rotation += (int(self.getObjectTypeAtSensor(2)/2)*-1) * SensorBelt[2] 
        rotation += (int(self.getObjectTypeAtSensor(3)/2)*-1) * SensorBelt[3] 
        rotation += (int(self.getObjectTypeAtSensor(4)/2)*-1) * SensorBelt[4] 
        rotation += (int (self.getObjectTypeAtSensor(5)/2)*-1) * SensorBelt[5] 
        rotation += (int(self.getObjectTypeAtSensor(6)/2)*-1) * SensorBelt[6] 
        rotation += (int(self.getObjectTypeAtSensor(7)/2)*-1) * SensorBelt[7] 
