...
class AgentTypeA(object):
    ...
    teamname = "Equipe chekirou_kaci" # A modifier avec le nom de votre équipe
    ...
    def stepController(self):
        ...
        """
        rotation  =  0.0
        rotation += (((self.getObjectTypeAtSensor(0)+3)%4)-2) * SensorBelt[0] 
        rotation += (((self.getObjectTypeAtSensor(1)+3)%4)-2) * SensorBelt[1] 
        rotation += (((self.getObjectTypeAtSensor(2)+3)%4)-2) * SensorBelt[2] 
        rotation += (((self.getObjectTypeAtSensor(3)+3)%4)-2) * SensorBelt[3] 
        rotation += (((self.getObjectTypeAtSensor(4)+3)%4)-2) * SensorBelt[4] 
        rotation += (((self.getObjectTypeAtSensor(5)+3)%4)-2) * SensorBelt[5] 
        rotation += (((self.getObjectTypeAtSensor(6)+3)%4)-2) * SensorBelt[6] 
        rotation += (((self.getObjectTypeAtSensor(7)+3)%4)-2) * SensorBelt[7]
