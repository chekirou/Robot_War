...
class Agent(object):
    ...
    def stepController(self):
        ...
        params = [-0.3960143537181511, -0.21096938988297365, 0.008321171130159177, -0.9161951932932706, -0.8373006701973885, -0.9393687585595113, -0.11681334545737525, 0.7077295496936932, 0.8220263992945838, -0.29330149775338094, -0.2675265841387413, -0.7210590778969956, -0.6083490766114465, 0.33466769208242564]
        ...
        translation =  math.tanh( sensorMinus40 * params[0] + sensorMinus20 * params[1] + sensorPlus20 * params[2] + sensorPlus40 * params[3] + sensorMinus80 * params[11] + sensorPlus80 * params[10] + params[4] ) 
        rotation =  math.tanh( sensorMinus40 * params[5] + sensorMinus20 * params[6] + sensorPlus20 * params[7] + sensorPlus40 * params[8] + sensorMinus80 * params[12] + sensorPlus80 * params[13] + params[9])
